...
namespace weave
{
    public partial class FullBleedNewsItemControl : BaseNewsItemControl, IDisposable
    {
        ...
        public FullBleedNewsItemControl()
        {
            InitializeComponent();
        ...
        protected override void SetNewsItem(NewsItem newsItem)
        {
            ...
            this.root.SetBinding(UIElement.OpacityProperty, b);
